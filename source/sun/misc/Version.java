...
public class Version {
    ...
    private static final String java_vendor_version =
        "Zulu 8.64.0.19-CA-macos-aarch64";

    private static final String azul_runtime_name =
        "Zulu 8.64.0.19-CA-macos-aarch64";
    ...
    public static void init() {
        ...
        System.setProperty("jdk.vendor.version", java_vendor_version);
    }
    ...
    public static void print(PrintStream ps) {
        ...
        ps.print(java_runtime_name + " ("+ azul_runtime_name +")");
        if (azul_runtime_suffix.length() > 0) {
            ps.print("-" + azul_runtime_suffix);
        }
        ...
        if (azul_version_suffix.length() > 0) {
            ps.println(") " + azul_version_suffix);
        } else {
            ps.println(')');
        }
        ...
        ps.print(java_vm_name + " ("+ azul_runtime_name +")");
        if (azul_runtime_suffix.length() > 0) {
            ps.print("-" + azul_runtime_suffix);
        }
        ps.print( " (build " + java_vm_version + ", " +
                 java_vm_info);
        if (azul_version_suffix.length() > 0) {
            ps.println(") " + azul_version_suffix);
        } else {
